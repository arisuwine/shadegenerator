...
public:
	...
	//-----------------------------------------------------------------------------
	// using RegisterLoggingChannelFunc = LoggingChannelID_t(__fastcall*)(const char *pChannelName, RegisterTagsFunc registerTagsFunc, int flags, LoggingVerbosity_t verbosity, Color spewColor);
	// RegisterLoggingChannelFunc RegisterLoggingChannel = reinterpret_cast<RegisterLoggingChannelFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_RegisterLoggingChannel"));
...
using RegisterLoggingChannelFunc = LoggingChannelID_t(__fastcall*)(const char *pChannelName, RegisterTagsFunc registerTagsFunc, int flags, LoggingVerbosity_t verbosity, Color spewColor);
inline RegisterLoggingChannelFunc LoggingSystem_RegisterLoggingChannel = reinterpret_cast<RegisterLoggingChannelFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_RegisterLoggingChannel"));
...
using LoggingSystem_FindChannelFunc = LoggingChannelID_t(*)(const char*);

inline LoggingSystem_FindChannelFunc LoggingSystem_FindChannel = reinterpret_cast<LoggingSystem_FindChannelFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_FindChannel"));
...
using LoggingSystem_GetFirstChannelIDFunc = LoggingChannelID_t(*)();
inline LoggingSystem_GetFirstChannelIDFunc LoggingSystem_GetFirstChannelID = reinterpret_cast<LoggingSystem_GetFirstChannelIDFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_GetFirstChannelID"));
...
using LoggingSystem_GetNextChannelIDFunc = LoggingChannelID_t(*)(LoggingChannelID_t);
inline LoggingSystem_GetNextChannelIDFunc LoggingSystem_GetNextChannelID = reinterpret_cast<LoggingSystem_GetNextChannelIDFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_GetNextChannelID"));

// PLATFORM_INTERFACE LoggingChannelID_t LoggingSystem_GetNextChannelID( LoggingChannelID_t channelID );

using LoggingSystem_GetChannelFunc = CLoggingSystem::LoggingChannel_t*(*)(LoggingChannelID_t);
inline LoggingSystem_GetChannelFunc LoggingSystem_GetChannel = reinterpret_cast<LoggingSystem_GetChannelFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_GetChannel"));
...
using LoggingSystem_GetChannelColorFunc = int32(*)(LoggingChannelID_t);
inline LoggingSystem_GetChannelColorFunc LoggingSystem_GetChannelColor = reinterpret_cast<LoggingSystem_GetChannelColorFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_GetChannelColor"));

// PLATFORM_INTERFACE int32 LoggingSystem_GetChannelColor( LoggingChannelID_t channelID );


using LoggingSystem_SetChannelColorFunc = void(*)(LoggingChannelID_t, int);
inline LoggingSystem_SetChannelColorFunc LoggingSystem_SetChannelColor = reinterpret_cast<LoggingSystem_SetChannelColorFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "LoggingSystem_SetChannelColor"));
...
using LoggingSystem_LogDirectFunc = LoggingResponse_t(__fastcall*)(LoggingChannelID_t channelID, LoggingSeverity_t severity, Color spewColor, const char *pMessage);
// inline LoggingSystem_LogDirectFunc GameConsoleLog = reinterpret_cast<LoggingSystem_LogDirectFunc>(GetProcAddress(GetModuleHandleA("tier0.dll"), "?LoggingSystem_LogDirect@@YA?AW4LoggingResponse_t@@HW4LoggingSeverity_t@@VColor@@PEBD@Z"));

LoggingSystem_LogDirectFunc LoggingSystem_LogDirect( LoggingChannelID_t channelID, LoggingSeverity_t severity, Color spewColor, const char *pMessage );
